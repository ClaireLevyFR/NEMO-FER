...
!}
         ...
         IF ( Agrif_Fixed() == 2 ) THEN
                  IF(lwp) WRITE(numout,*) ' Modify fmask in the', Agrif_Fixed(), ' grid'
                  IF(lwp) WRITE(numout,*) ' We impose a free slip condition in open ocean'
                  ! Hudson bay entry Ok 
                  ii0 =  1      ;   ii1 =  1
                  ij0 =  604    ;   ij1 =  681
                  fmask(mi0(ii0):mi1(ii1) , mj0(ij0):mj1(ij1),jk) = 0._wp
                  ...
                  ! upper Eastern boundary (above Iceland) Ok
                  ii0 =  1175   ;   ii1 =  1175   
                  ij0 =  667    ;   ij1 =  695
                  fmask(mi0(ii0):mi1(ii1) , mj0(ij0):mj1(ij1),jk) = 0._wp

                  ! Eastern boundary Iceland Fjord
                  ii0 =  1175   ;   ii1 =  1175   
                  ij0 =  540    ;   ij1 =  568
                  fmask(mi0(ii0):mi1(ii1) , mj0(ij0):mj1(ij1),jk) = 0._wp
